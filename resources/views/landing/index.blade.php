...
@push('styles')
    <style>
        ...
        .navbar {
            background: #2e8b57;
            padding: 15px 20px;
            /* ← Tambahkan padding kiri-kanan di sini */
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
        ...
        .navbar-container {
            ...
            /* ← Logo kiri, toggle kanan */
            align-items: center;
            width: 100%;
            /* ← Full lebar layar */
            padding: 0 15px;
            /* ← Jarak kiri-kanan sedikit */
            max-width: 100%;
            /* ← Tambahkan ini */
        }
        ...
        @media (max-width: 768px) {
            .navbar-container {
                flex-wrap: nowrap;
                /* ← Jangan biarkan elemen turun ke baris baru */
                padding: 0 10px;
                /* ← Jaga jarak kiri-kanan di HP */
            }
            ...
            /* Pastikan Container menggunakan Space Between */
            .navbar-container {
                justify-content: space-between;
                /* Logo di kiri, Toggle di kanan */
                align-items: center;
            }
            ...
            @media (max-width: 768px) {
                ...
                /* Atur Menu: Sembunyikan dulu, muncul saat diklik */
                .navbar-menu {
                    display: none;
                    /* Hidden by default */
                    position: absolute;
                ...
                /* Perbaiki layout container di mobile agar tidak menumpuk */
                .navbar-container {
                    flex-wrap: nowrap;
                    /* Jangan biarkan turun ke bawah */
                }
                ...
                .about-icon img {
                    ...
                    /* ← Ukuran logo (sesuaikan) */
                    height: auto !important;
                }


                /* Desktop - Logo tetap di tengah */
