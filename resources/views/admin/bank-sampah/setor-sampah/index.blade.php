...
<div class="page-container">
    ...
    <div class="header-wrapper">
            ...
            <form id="filterForm" method="GET" action="{{ route('admin.bank-sampah.setor.index') }}">
                <div class="filter-group">
                    ...
                    @if(request('bulan') || request('tahun') || request('search'))
                        <a href="{{ route('admin.bank-sampah.setor.index') }}" class="btn-filter reset" style="background:#6c757d;">
        ...
        <div class="top-search">
            <div class="search-wrapper">
                ...
                <input type="text" id="liveSearchInput" class="search-input" placeholder="Cari nama atau jenis sampah..." value="{{ request('search') }}">
                <button type="button" id="clearSearch" style="display: none; background:none; border:none; color:#888; cursor:pointer; padding:0 5px;">
    ...
    <div class="table-container">
        ...
        <div class="pagination-container">
            <div>
                Menampilkan {{ $setorData->firstItem() }} - {{ $setorData->lastItem() }} dari {{ $setorData->total() }} data
            </div>
