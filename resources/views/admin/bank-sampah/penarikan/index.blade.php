                        ...
                        <tr class="empty-row">
                            <td colspan="7">
                                <svg width="48" height="48" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" style="margin-bottom: 0.5rem; opacity: 0.5;">
            ...
            <div class="modal-body">
                <form id="detailForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="detail-jumlah" class="form-input" readonly
                            style="font-weight: bold; color: var(--primary-green);">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="detail-ewallet" class="form-input" readonly
                            style="margin-top: 0.5rem;" placeholder="Nomor E-Wallet">
                    </div>
                    ...
                    <div style="border-top: 2px solid var(--gray-200); padding-top: 1.25rem; margin-top: 1.25rem;">
                        <label class="form-label" style="color: var(--primary-green); font-weight: 700;">Update
                            Status</label>
                        <select id="detail-status" class="form-select" onchange="toggleStatusInfo()">
                            <option value="diproses">🔄 Diproses</option>
                            <option value="berhasil" style="color: green; font-weight: bold;">✅ Berhasil (Setujui)
                            </option>
                    ...
                    <div id="alasanPenolakanGroup" class="form-group" style="display:none; margin-top:1rem;">
                        <label class="form-label" style="color:var(--red);">Alasan Penolakan <span
                                style="color:var(--red);">*</span></label>
                        <textarea id="detail-alasan" class="form-input" rows="3"
                            placeholder="Masukkan alasan mengapa penarikan ditolak..."></textarea>
                    </div>
